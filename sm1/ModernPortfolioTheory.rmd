...
<!-- \begin{figure} -->
<!--   \centering -->
<!--   \includegraphics{equal_weights_value_plot.png} -->
<!--   \caption{Portfolio value with the assets equally weighted.} -->
...
<!-- \begin{figure} -->
<!--   \centering -->
<!--   \includegraphics{least_squares_0.5_value_plot.png} -->
<!--   \caption{Portfolio value with the assets optimised using .} -->
<!--   \label{fig:equal_weights} -->
<!-- \end{figure} -->

\begin{figure}
  \centering
  \includegraphics{equal_weights_value.png}
  \caption{Portfolio value with the assets equally weighted.}
  \label{fig:equal_weights}
\end{figure}
